...
# 캐릭터 만들기
character = pygame.image.load(os.path.join(image_path, "character.1.png"))
...
while running:
    ...
    for ball_idx,ball_val in enumerate(balls):
        ...
        for weapon_idx, weapon_val in enumerate(weapons):
            ...
            if weapon_rect.colliderect(ball_rect):
                ...
                if ball_ima_idx < 3:
                    ...
                    #나눠진 공 정보
                    small_ball_rect = ball_images[ball_img_idx +1].get.rect()
        ...
        break # 안쪽 for문에서 break를 만나면 여기로 진입 가능. 2중 for 문을 한번에 빠져나온다.
    ...
    timer = game_font.render("Time : {}".format(int(tottal_time - elapsed_time)),True, (255, 255, 255))
    screen.blit(timer, (10, 10))

    # 시간 초과했다면
    if tottal_time - elapsed_time <= 0:
